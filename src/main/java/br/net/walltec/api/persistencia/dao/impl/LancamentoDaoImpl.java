...
public class LancamentoDaoImpl extends AbstractPersistenciaPadraoDao<Lancamento> implements LancamentoDao {
	...
	//TODO: criar namedquery
	@Override
	public ResumoLancamentosDTO obterResumoLancamentos(Integer mes,
		...
		if (result != null){
			ResumoLancamentosDTO vo = new ResumoLancamentosDTO();
	...
	//TODO: criar namedquery
	@Override
	public List<UtilizacaoLancamentoDTO> listarUsos(Integer idLancamentoOrigem) throws PersistenciaException {
