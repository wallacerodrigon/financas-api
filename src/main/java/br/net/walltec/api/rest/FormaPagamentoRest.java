...
@Api(value="Webservice de formas de pagamento")

@SuppressWarnings("serial")
public class FormaPagamentoRest extends RequisicaoRestPadrao<FormaPagamento> {
	 ...
	 */
	@Override
	public CrudPadraoService<FormaPagamento> getServico() {
		return service;
	}
	 ...
	 */
	@Override
	protected Class<FormaPagamento> getClasseEntidade() {
