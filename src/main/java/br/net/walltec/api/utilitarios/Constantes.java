...
public class Constantes { 
	...
	public static final int INTERVALO_TOKEN = 1000 * 60; // 1 min

	public static final String X_CSRF = "X-CSRF";

	public static final String SEPARADOR_STATUS = ";";
	
	public static final Integer ID_CONTA_DEBITO = 152;
	
	public static final Integer ID_CONTA_CREDITO = 736;
	
	public static final String SCHEMA_FINANCAS = "financas";

	public static final int INTERVALO_REFRESH_TOKEN = 3600000; //1 hora
		
	public static final String USUARIO_AUTENTICADO = "AUTENTICADO";
	
	public static final String TAG_HASH_TOKEN = "hash_token";
}
