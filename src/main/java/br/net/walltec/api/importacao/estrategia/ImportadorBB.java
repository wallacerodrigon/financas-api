...
//	
//	@Override
//    public List<RegistroExtratoDto> importar(String nomeArquivo, byte[] dadosArquivo, List<Lancamento> listaParcelas) throws NegocioException {
//    	
...
//	 * @return
//	 */
//	private List<Lancamento> filtrarLancamentosDebContaPagos(List<Lancamento> listaParcelas) {
//		List<Lancamento> lancamentosDisponiveis = listaParcelas
//				.stream()
...
//	 */
//	private List<RegistroExtratoDto> associarDtoALancamentos(List<RegistroExtratoDto> dtos, List<Lancamento> lancamentosDisponiveis) {
//		//tentar associar por documento
//    	Map<String, List<Lancamento>> lancamentosPorDocumento = mapearLancamentosPorDocumento(lancamentosDisponiveis);
//		associarPorDocumento(lancamentosPorDocumento, dtos);
//    	List<Lancamento> naoAssociados = recuperarLancamentosNaoAssociados(lancamentosDisponiveis, lancamentosPorDocumento);
...
//	 * @return
//	 */
//	private List<Lancamento> recuperarLancamentosNaoAssociados(List<Lancamento> lancamentosDisponiveis,
//			Map<String, List<Lancamento>> lancamentosPorDocumento) {
//		List<Lancamento> lancamentosAssociadosPorDocumento = extrairLancamentoVO(lancamentosPorDocumento);		
//		return lancamentosDisponiveis
//				.stream()
